...
- `validate-security-baseline.sh` inventories GuardDuty, Security Hub, IAM Access Analyzer, AWS Config aggregation, S3 account Public Access Block, Inspector, and Macie using read-only AWS APIs.
